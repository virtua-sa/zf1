 ...
 */
class Zend_Dojo_View_Helper_TimeTextBoxTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->helper = new Zend_Dojo_View_Helper_TimeTextBox();
    ...
    {
        return $this->helper->timeTextBox(
            'elementId',
            '2008-07-07',
            array(
                'required'    => true,
    ...
    public function testShouldAllowDeclarativeDijitCreation()
    {
        ...
        $this->assertRegexp('/<input[^>]*(dojoType="dijit.form.TimeTextBox")/', $html, $html);
    }
