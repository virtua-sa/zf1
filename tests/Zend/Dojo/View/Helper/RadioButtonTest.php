...
require_once 'Zend/Dojo/View/Helper/RadioButton.php';
 ...
 */
class Zend_Dojo_View_Helper_RadioButtonTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->helper = new Zend_Dojo_View_Helper_RadioButton();
