...
class Zend_Cloud_Infrastructure_Adapter_Rackspace extends Zend_Cloud_Infrastructure_Adapter_AbstractAdapter
{
     ...
     *
     * @return Zend_Cloud_Infrastructure_InstanceList|boolean
     */
     ...
     * @param string $name
     * @param array $options
     * @return Zend_Cloud_Infrastructure_Instance|boolean
     */
     ...
     *
     * @return Zend_Cloud_Infrastructure_ImageList|boolean
     */
